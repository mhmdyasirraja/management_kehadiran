...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm flex justify-between items-center">
        ...
        @if(!$sudahCheckIn)
            ...
            <form id="form-checkin" action="/karyawan/checkin" method="POST">
                @csrf
                ...
                <button
                    type="button"
                    onclick="submitAbsensi('form-checkin')"
        ...
        @elseif(!$sudahCheckOut)
            ...
            <form id="form-checkout" action="/karyawan/checkout" method="POST">
                @csrf
                ...
                <button
                    type="button"
                    onclick="submitAbsensi('form-checkout')"
